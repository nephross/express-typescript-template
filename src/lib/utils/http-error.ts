...
* micropayment scheme, but that has not happened, and this code is not usually used. Google Developers API uses this status if a
...
/*
* There is a lookup of common HTTP status codes and their friendly names in NodeJS. http.STATUS_CODES is the object of which I speak,
* where each key is a status code, and the matching value is the human readable description.
